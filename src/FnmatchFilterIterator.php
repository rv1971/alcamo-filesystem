 ...
 * @namespace alcamo::filesystem
 *
 * @brief Filesystem-related stuff
 */
 ...
 * - The keys of the inner iterator are filenames without path, and @ref
 * FILTER_KEY is set in the flags.
...
class FnmatchFilterIterator extends \FilterIterator
{
     ...
     *
     * @param $flags OR-Combination of fnmatch() flags and class constants.
     */
    public function __construct(
        ...
        switch (true) {
            case isset($flags):
                 ...
                 *  set ref $flags_ to @ref FILTER_KEY. */
